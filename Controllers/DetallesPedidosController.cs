...
namespace ANNIE_SHOP.Controllers
{
    public class DetallesPedidosController : BaseController
    {
        ...
        public async Task<IActionResult> Details(int? id)
        {
            ...
            var detalle_Pedido = await _context.DetallesPedidos
                .Include(d => d.Pedido)
        ...
        public async Task<IActionResult> Edit(int? id)
        {
            ...
            var detalle_Pedido = await _context.DetallesPedidos.FindAsync(id);
            if (detalle_Pedido == null)
            {
                return NotFound();
            }
        ...
        public async Task<IActionResult> DeleteConfirmed(int id)
        {
            ...
            if (detalle_Pedido != null)
            {
                _context.DetallesPedidos.Remove(detalle_Pedido);
                await _context.SaveChangesAsync();
            }
            return RedirectToAction(nameof(Index));
        }
